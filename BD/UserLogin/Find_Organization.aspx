<%@ Page Title="" Language="C#" MasterPageFile="~/UserLogin/UserHome.master" AutoEventWireup="true" CodeFile="Find_Organization.aspx.cs" Inherits="UserLogin_Find_Organization" %>
    ...
    <tr>
        ...
        <td>
            <asp:Button ID="FindDataB1" runat="server" Font-Bold="True" Font-Size="Medium" 
                    Text="Find Data" Visible="False" BackColor="Black" 
    ...
    <tr>
        <td colspan="3">
            <asp:GridView ID="GVOrgDataFind2" runat="server" AutoGenerateColumns="False" 
                ...
                BorderStyle="Solid" BorderWidth="1px" Width="634px">
